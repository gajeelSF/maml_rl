...
class HalfCheetahEnvMass(MujocoEnv, Serializable):
    ...
    def sample_goals(self, num_goals):
        return np.random.uniform(1.0, 2.0, (num_goals, ))
    ...
    def reset(self, init_state=None, reset_args=None, **kwargs):
        ...
        if goal_vel is not None:
            ...
            self._goal_vel = np.random.uniform(1.0, 2.0)
        self.reset_mujoco(init_state)
        self.model.body_mass[1][2] = self._goal_vel
        self.model.forward()
